...
function trierTableau() {
  ...
  lignes.forEach(function (ligne) {
    // On lit les data-attributes posés à la création de la ligne
    // Pour les lignes HTML statiques (déjà dans la page), on lit
    // directement le texte des cellules par leur index correct
