...
<section class="sidebar">
  ...
  <nav class="menu">
    ...
    @if(in_array(auth()->user()->myuser->role, ['administrateur', 'collaborateur']))
    <a href="{{ route('contrats.index') }}" class="menu-item">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
        viewBox="0 0 24 24" fill="none"
        stroke="currentColor" stroke-width="2" 
        stroke-linecap="round" stroke-linejoin="round"
        class="icon icon-tabler icons-tabler-outline icon-tabler-file-signature">
        ...
        <path d="M9 17c1.5 -1 3 -1 4 0s2.5 1 4 0"/>
      </svg>
      <span>Liste Contrat</span>
    </a>
    @endif
