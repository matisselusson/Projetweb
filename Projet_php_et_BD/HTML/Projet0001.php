...
<section class="sidebar">
  ...
  <div class="cell" id="ticket_title">
    ...
    <div class="number-cell"><?= htmlspecialchars($pr["titre"],       ENT_QUOTES, 'UTF-8') ?></div>
  </div>

  <div class="cell" id="id_ticket">
    <div class="title-cell">Description</div>
    <div class="number-cell"><?= htmlspecialchars($pr["description"], ENT_QUOTES, 'UTF-8') ?></div>
  </div>

  <div class="cell" id="ticket_priority">
    <div class="title-cell">Priorité</div>
    <div class="number-cell"><?= htmlspecialchars($pr["priorite"],    ENT_QUOTES, 'UTF-8') ?></div>
  </div>

  <div class="cell" id="ticket_status">
    <div class="title-cell">Statut</div>
    <div class="number-cell"><?= htmlspecialchars($pr["statut"],      ENT_QUOTES, 'UTF-8') ?></div>
  </div>

  <div class="cell" id="ticket_assignee">
    <div class="title-cell">Assigné à</div>
    <div class="number-cell"><?= htmlspecialchars($pr["assigne"],     ENT_QUOTES, 'UTF-8') ?></div>
  </div>
